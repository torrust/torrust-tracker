...
| 8   | `PRRT_kwDOGp2yqc6SW8jK` | `docs/copilot-pr-reviews/pr-2007-copilot-suggestions.md`                  | [comment](https://github.com/torrust/torrust-tracker/pull/2007#discussion_r3616827507) | Tracker file should use `<!-- cspell:disable -->` instead of adding ID fragments to global dictionary                             | action    | DONE   | resolved     |
