...
epic: null
github-issue: 2203
spec-path: docs/issues/closed/2203-template-catalog-and-cargo-dependency-pr-template/ISSUE.md
...
- 2026-09-11 UTC - Repository maintenance - Archived this closed issue specification in `docs/issues/closed/2203-template-catalog-and-cargo-dependency-pr-template/`.
