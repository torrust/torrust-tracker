...
epic: null
github-issue: 2226
spec-path: docs/issues/closed/2226-fix-stale-inactivity-cutoff-in-activity-metrics-updater/ISSUE.md
branch: null
related-pr: null
...
semantic-links:
  ...
  related-artifacts:
    ...
    - docs/issues/closed/2226-fix-stale-inactivity-cutoff-in-activity-metrics-updater/evidence.md
    - docs/issues/closed/2226-fix-stale-inactivity-cutoff-in-activity-metrics-updater/manual-verification-evidence.md
    - docs/issues/closed/2226-fix-stale-inactivity-cutoff-in-activity-metrics-updater/forensic-findings.md
    - docs/issues/closed/2226-fix-stale-inactivity-cutoff-in-activity-metrics-updater/follow-up-issue-draft.md
    - docs/issues/closed/2226-fix-stale-inactivity-cutoff-in-activity-metrics-updater/implementation-retrospective.md
    - docs/issues/closed/2226-fix-stale-inactivity-cutoff-in-activity-metrics-updater/agent-review-reports.md
---
...
- [x] Folder-style spec drafted and promoted to `docs/issues/closed/2226-fix-stale-inactivity-cutoff-in-activity-metrics-updater/ISSUE.md`
...
- 2026-09-25 - GitHub Copilot - Verified GitHub issue #2226 is closed and archived this specification in `docs/issues/closed/`.
