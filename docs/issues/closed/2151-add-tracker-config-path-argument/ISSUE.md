...
epic: null
github-issue: 2151
spec-path: docs/issues/closed/2151-add-tracker-config-path-argument/ISSUE.md
...
semantic-links:
  skill-links:
    - create-issue
  related-artifacts:
    - docs/issues/closed/2151-add-tracker-config-path-argument/rust-executable-test-plan.md
    - src/main.rs
    - src/app.rs
...
- 2026-09-11 UTC - Repository maintenance - Archived this closed issue specification in `docs/issues/closed/2151-add-tracker-config-path-argument/`.
