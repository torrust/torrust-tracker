...
| A159 | Removed | crate | `empty_enums` | UDP protocol macro expansion | #2261 found no stable or nightly diagnostic from the current `FromBytes` derives after removing the allowance. | #2261 | Removed |
