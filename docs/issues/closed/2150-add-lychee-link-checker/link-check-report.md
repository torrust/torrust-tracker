...
| `docs/issues/drafts/1669-01-establish-baseline-analysis/ISSUE.md`                                                           | 1        | Fix — corrected the coupling-report path.                                              |
| `docs/issues/drafts/increase-main-app-integration-test-coverage/ISSUE.md`                                                   | 2        | Fix — corrected historical test-reference paths.                                       |
