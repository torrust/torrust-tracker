...
epic: null
github-issue: 2162
spec-path: docs/issues/closed/2162-enforce-lychee-and-schedule-external-link-checks/ISSUE.md
...
- 2026-09-11 UTC - Repository maintenance - Archived this closed issue specification in `docs/issues/closed/2162-enforce-lychee-and-schedule-external-link-checks/`.
