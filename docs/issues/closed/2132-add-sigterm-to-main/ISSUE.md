...
priority: p1
github-issue: 2132
spec-path: docs/issues/closed/2132-add-sigterm-to-main/ISSUE.md
...
- 2026-09-11 UTC - Repository maintenance - Archived this closed issue specification in `docs/issues/closed/2132-add-sigterm-to-main/`.
