...
| 4.1   | #1868 - Exclude irrelevant workspace members from container build                            | `docs/issues/open/1868-1840-workflow-performance-exclude-irrelevant-workspace-members/ISSUE.md` | TODO       | Follow-up to #1853. Post-merge CI analysis showed `workspace-coupling` and `torrust-tracker-torrent-repository-benchmarking` are still compiled despite being unneeded in the tracker image. Add `--exclude` flags to all cargo commands. Baseline: 19m03s build step after #1853.                                                                                                          |
