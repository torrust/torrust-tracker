...
This issue focuses only on dependency-skill automation. Pre-commit performance/verbosity is tracked separately in [docs/issues/closed/1769-refactor-pre-commit-checks-performance-and-verbosity/ISSUE.md](../../closed/1769-refactor-pre-commit-checks-performance-and-verbosity/ISSUE.md).
...
- Related split issue spec: [docs/issues/closed/1769-refactor-pre-commit-checks-performance-and-verbosity/ISSUE.md](../../closed/1769-refactor-pre-commit-checks-performance-and-verbosity/ISSUE.md)
