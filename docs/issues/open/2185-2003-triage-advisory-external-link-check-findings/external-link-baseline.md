...
- **Next action:** The replacement `https://caddyserver.com/docs/caddyfile/options#servers` returned HTTP 200. Run focused local validation, then a hosted workflow to verify the retired URL is absent while unrelated external-link failures remain visible.
...
| `https://caddyserver.com/docs/protocol/http3`                                                                                               | `404`            | `docs/containers.md`                                                | C5: replaced with Caddy server options |
