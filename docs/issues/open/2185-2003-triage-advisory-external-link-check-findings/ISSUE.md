...
related-pr: null
last-updated-utc: 2026-09-14 16:05
semantic-links:
  skill-links:
    - create-issue
  related-artifacts:
...
| T2  | IN_PROGRESS | Repair clearly stale references           | C3 and C4 are hosted-verified; C5-C6 investigation and repair remain. |
