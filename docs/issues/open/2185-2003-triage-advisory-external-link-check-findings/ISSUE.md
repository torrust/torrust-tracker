...
| T2  | IN_PROGRESS | Repair clearly stale references           | C3 is hosted-verified; C4's three repository-controlled stale links are repaired locally and await hosted verification. |
