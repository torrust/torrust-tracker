...
| T2  | IN_PROGRESS | Repair clearly stale references           | C3 and C4 are hosted-verified; C5's initial hosted run exposed an invalid replacement fragment, and the repair without a fragment awaits hosted verification, while C6 remains under investigation. |
