...
| 7     | [#1136](../../issues/1136) — Add configurable UDP connection ID validation policy                              | `docs/issues/open/1136-1978-configurable-udp-connection-id-validation-policy.md`        | IN_PROGRESS | Per-listener `strict`/`disabled` policy; metrics emitted in both modes; IP-ban only in strict; branch `1136-connection-id-validation-policy` opened   |
