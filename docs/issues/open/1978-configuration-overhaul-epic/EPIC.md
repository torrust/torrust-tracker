...
| 14    | [#2023](https://github.com/torrust/torrust-tracker/issues/2023) — Expose configured public URLs in runtime observability                            | `docs/issues/open/2023-1978-expose-configured-public-urls-in-runtime-observability/ISSUE.md` | DONE   | Implemented with automated and reproducible local runtime verification; evidence is recorded in the issue folder.                                         |
...
| ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------- |
| [#2079](https://github.com/torrust/torrust-tracker/issues/2079) — Adopt `secrecy` for sensitive configuration | `docs/issues/open/2079-adopt-secrecy-for-sensitive-configuration.md` | DONE   | Protects API tokens and establishes the secret convention used by v3 database passwords. |
