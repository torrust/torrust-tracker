...
- 2026-09-25 07:35 UTC - josecelano, GitHub Copilot - Removed `torrust-runner-01`: uninstalled the service, deleted the registration from the repository, and removed the install directory from the server; GitHub reports no self-hosted runner - [`runner-agent-installation.md`](runner-agent-installation.md) step 6
