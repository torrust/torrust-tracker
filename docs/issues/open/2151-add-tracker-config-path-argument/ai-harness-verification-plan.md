...
| H6  | IN_PROGRESS | Apply the policy to #2151    | The issue now records `release-cli-verification.py` as historical disposable automation and resets M1-M5 for real release-style manual runs. Create `manual-verification-evidence.md`, remove the script under R7, then record actual results.                                                                      |
