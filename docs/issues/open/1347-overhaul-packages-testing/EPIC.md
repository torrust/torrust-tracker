...
| 6     | #2222 - Prevent per-package coverage regressions  | `docs/issues/open/2222-1347-package-coverage-regression-ci/ISSUE.md`              | DONE   | Merged through PR #2293 as a report-only CI coverage comparison; #2301 will review rollout evidence after this EPIC completes. |
