...
| ----- | ----- | ---------- | ------ | ----- |
| 1 | #[To be assigned] - Single-source the audit field roster and mark copied template sections | `docs/issues/open/{number}-2278-single-source-audit-roster/ISSUE.md` | TODO | F58, F77, F63. Docs only. No dependencies. Unblocks 2, 4, and 7. |
