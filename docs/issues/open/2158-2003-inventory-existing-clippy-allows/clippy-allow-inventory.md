...
| A156, A171 | Temporary | [`wire-numeric-conversion-validation.md`](numeric-conversion-follow-up-drafts/wire-numeric-conversion-validation.md): prove protocol-width bounds through types or checked conversions, then remove/narrow the allows. |
...
| A156 | `packages/udp-protocol/src/lib.rs:8` | crate | `cast_possible_truncation` | Wire conversion validation | [Wire conversion draft](numeric-conversion-follow-up-drafts/wire-numeric-conversion-validation.md) defines the protocol-bound removal condition | #2158 | Temporary |
