...
| Peer-ID move               | #TBD — Move `bittorrent-peer-id` to `torrust/torrust-bittorrent` as `torrust-peer-id`                                                                                            | [docs/issues/drafts/1669-extract-bittorrent-peer-id-to-torrust-bittorrent.md](../../drafts/1669-extract-bittorrent-peer-id-to-torrust-bittorrent.md)                                           | TODO   | Rule E; no workspace deps in crate; 3 consumers to migrate; first `bittorrent-*` extraction sequence item                                     |
...
- [docs/issues/drafts/1669-extract-bittorrent-peer-id-to-torrust-bittorrent.md](../../drafts/1669-extract-bittorrent-peer-id-to-torrust-bittorrent.md)
