...
- [x] [#1910](https://github.com/torrust/torrust-tracker/issues/1910) SI-29: Remove redundant `-tracker-` from HTTP and UDP crate names _(Rule U; rename 4 unpublished packages to match DEC-15 folder convention)_ — **DONE**
- [ ] [#1924](https://github.com/torrust/torrust-tracker/issues/1924) SI-30: Decouple `rest-api-core` and `axum-rest-api-server` from concrete UDP server internals _(Rule M; core → server layer violation; needs trait abstractions)_
...
| REST API decoupling        | [#1924](https://github.com/torrust/torrust-tracker/issues/1924) SI-30: Decouple `rest-api-core` and `axum-rest-api-server` from concrete UDP server internals                    | [docs/issues/open/1924-1669-si-30-decouple-rest-api-core-from-udp-internals.md](../../open/1924-1669-si-30-decouple-rest-api-core-from-udp-internals.md)                                       | TODO   | Rule M; core → server layer violation; trait abstractions; MAX_CONNECTION_ID_ERRORS_PER_IP → config option                                    |
