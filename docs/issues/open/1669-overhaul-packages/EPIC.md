...
| Net primitives split       | [#1797](https://github.com/torrust/torrust-tracker/issues/1797) — Create `torrust-net-primitives` and move `ServiceBinding` from `torrust-tracker-primitives`                             | [docs/issues/closed/1797-1669-05-create-torrust-net-primitives-and-move-service-binding/ISSUE.md](../../closed/1797-1669-05-create-torrust-net-primitives-and-move-service-binding/ISSUE.md)               | DONE   | Rule M + new package; generic networking type; completed                                                                                      |
