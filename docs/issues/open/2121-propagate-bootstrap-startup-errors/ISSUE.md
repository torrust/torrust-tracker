...
| AC5   | DONE                   | `app::run`, `start`, and starters return typed errors; focused library tests pass.                                                                                                                                                                                                    |
| AC6   | DONE                   | `app::tests::it_should_release_udp_listener_before_returning_from_run_after_setup_when_later_http_startup_fails`.                                                                                                                                                                     |
