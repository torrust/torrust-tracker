...
- 2026-09-11 19:58 UTC: Cameron's follow-up check confirmed this correction was already present in `80f5eb23`; the thread was replied to and resolved at <https://github.com/torrust/torrust-tracker/pull/2207#discussion_r3993654943>.
- 2026-09-11: The six r1 replies on rows 1-6 cite `cef78cdb`, which was superseded by the force-push and is not in the PR history. Correction replies were posted on each thread pointing to `327794a7` (row 4) or `e028d627` (rows 1, 2, 3, 5, 6); the `Fix commit` column is authoritative.
...
separate so its completed findings are preserved beside `pr-2207-review.md`.
