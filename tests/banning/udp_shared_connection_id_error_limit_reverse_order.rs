//! UDP banning integration test — shared global connection-ID error limit with reverse listeners.
//!
//! This separate process reverses the listener declarations of the companion
//! target while exercising the same source socket and shared error budget.
#[path = "../common/mod.rs"]
mod common;
...
#[tokio::test]
async fn it_should_share_the_v3_connection_id_error_limit_across_udp_listeners_in_reverse_declaration_order() {
    // Arrange
