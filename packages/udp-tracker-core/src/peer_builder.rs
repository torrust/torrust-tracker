...
#[must_use]
pub fn from_request(announce_request: &torrust_tracker_udp_tracker_protocol::AnnounceRequest, peer_ip: &IpAddr) -> peer::Peer {
    let wire_event = torrust_tracker_udp_tracker_protocol::AnnounceEvent::from(announce_request.event);
    ...
    peer::Peer {
        ...
        event: match wire_event {
            ...
            torrust_tracker_udp_tracker_protocol::AnnounceEvent::Started => torrust_tracker_primitives::AnnounceEvent::Started,
            torrust_tracker_udp_tracker_protocol::AnnounceEvent::Stopped => torrust_tracker_primitives::AnnounceEvent::Stopped,
            torrust_tracker_udp_tracker_protocol::AnnounceEvent::None => torrust_tracker_primitives::AnnounceEvent::None,
        },
    }
}
