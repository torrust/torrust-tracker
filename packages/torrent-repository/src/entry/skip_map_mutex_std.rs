...
use crate::{EntrySkipMap, EntrySkipMapMutexStd};

impl EntrySync for EntrySkipMapMutexStd {
...
impl From<EntrySkipMap> for EntrySkipMapMutexStd {
    fn from(entry: EntrySkipMap) -> Self {
