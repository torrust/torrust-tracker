...
mod tests {
    ...
    use torrust_tracker_http_protocol::v1::requests::announce::{Announce, Compact, Event, NumberOfBytes, PeerIp};
    ...
    fn it_should_extract_the_announce_request_from_the_url_query_params() {
        ...
        assert_eq!(
            ...
            Announce {
                ...
                port: 17548,
                ip: PeerIp::Literal(IpAddr::V4(Ipv4Addr::new(2, 137, 87, 41))),
