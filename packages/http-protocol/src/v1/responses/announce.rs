...
/// use torrust_tracker_http_tracker_protocol::v1::responses::announce::{Normal, NormalPeer};
///
/// let peer = NormalPeer {
...
/// ```rust
///  use std::net::{IpAddr, Ipv4Addr};
///  use torrust_tracker_http_tracker_protocol::v1::responses::announce::{Compact, CompactPeer, CompactPeerData};
///
